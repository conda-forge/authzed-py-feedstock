...
Development: https://github.com/authzed/authzed-py
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/authzed-py-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/authzed-py-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install authzed-py
```
...
It is possible to list all of the versions of `authzed-py` available on your platform:
...
```
pixi search authzed-py --channel conda-forge
```
